    ...
    <Layout>
      <div className="min-h-screen bg-black">
            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              <div className="text-center lg:text-left space-y-5">
                ...
                <h1 className="text-4xl lg:text-6xl font-black leading-tight">
                  <span className="bg-gradient-to-r from-white via-gray-200 to-white bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(255,255,255,0.3)]">Réparation pro</span>
                  <span className="block text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-orange-500 to-orange-600 drop-shadow-[0_0_15px_rgba(249,115,22,0.5)] animate-pulse">& pièces sur mobilax.fr</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
                  <button onClick={() => setShowVideo(true)} className="group relative flex items-center justify-center gap-2 px-6 py-3 bg-black/50 backdrop-blur-sm border-2 border-orange-500 rounded-xl font-bold text-orange-400 transition-all duration-300 overflow-hidden shadow-[0_0_20px_rgba(249,115,22,0.3)] hover:shadow-[0_0_35px_rgba(249,115,22,0.6)] hover:scale-105 text-sm">
                    ...
                    <span className="relative z-10 flex items-center gap-2"><span className="text-lg group-hover:animate-pulse">▶</span><span>REGARDER LA VIDÉO</span></span>
                  </button>
                </div>
                <div className="flex flex-wrap gap-6 pt-6 justify-center lg:justify-start">
                  <div className="text-center"><div className="text-xl mb-1">📱</div><div className="text-xl font-black text-orange-400 drop-shadow-[0_0_8px_rgba(249,115,22,0.5)]">10K+</div><div className="text-[10px] text-gray-400">Appareils réparés</div></div>
                  <div className="text-center"><div className="text-xl mb-1">⭐</div><div className="text-xl font-black text-orange-400 drop-shadow-[0_0_8px_rgba(249,115,22,0.5)]">98%</div><div className="text-[10px] text-gray-400">Clients satisfaits</div></div>
                  <div className="text-center"><div className="text-xl mb-1">⚡</div><div className="text-xl font-black text-orange-400 drop-shadow-[0_0_8px_rgba(249,115,22,0.5)]">24h</div><div className="text-[10px] text-gray-400">Délai moyen</div></div>
                </div>
              </div>
              <div className="relative flex justify-center">
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl w-full max-w-lg">
                  <video autoPlay loop muted playsInline className="relative rounded-2xl w-full h-auto object-cover border-2 border-orange-500/50" style={{ maxHeight: "400px" }}>
                  ...
                  <div className="absolute bottom-3 right-3 bg-black/70 backdrop-blur-md rounded-full px-2.5 py-1 border border-orange-500/50 shadow-[0_0_10px_rgba(249,115,22,0.3)]">
                    <span className="text-orange-400 text-[10px] font-bold flex items-center gap-1"><span className="w-1.5 h-1.5 bg-red-500 rounded-full animate-pulse"></span>MBX</span>
                  </div>
                </div>
        ...
        <section id="centre" className="py-28 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">CENTRE DE RÉPARATION & FORMATION</h2>
              <p className="text-xl text-orange-400 max-w-3xl mx-auto font-light">Expertise – Technologie – Réparation Avancée</p>
            </div>
            <div className="text-center mb-20">
              <p className="text-gray-300 text-xl max-w-4xl mx-auto leading-relaxed">MBX Centre de Réparation & Formation est votre atelier spécialisé dans la réparation électronique, smartphone et microsoudure professionnelle.</p>
              <div className="flex flex-wrap justify-center gap-3 mt-8">
                {["iPhone", "Samsung", "Huawei", "Xiaomi", "Oppo", "Redmi", "Honor", "Tablettes"].map((brand) => (
                  <span key={brand} className="px-5 py-2.5 bg-gray-700/50 backdrop-blur-sm rounded-full text-sm font-medium hover:bg-gray-700 transition border border-gray-600">{brand}</span>
                ))}
              </div>
            </div>
            <div className="grid md:grid-cols-3 gap-8 mb-20">
              {[
                { icon: "📱", title: "Réparation & Remplacement", items: ["Écran LCD / OLED", "Batterie", "Connecteur de charge", "Caméra avant/arrière", "Micro & haut-parleur", "Boutons Power/Volume", "Vitre arrière", "Nappes & capteurs"] },
                { icon: "⚡", title: "Carte Mère & Microsoudure", subtitle: "Interventions avancées", items: ["Diagnostic électronique", "Réparation carte mère", "Circuits endommagés", "Court-circuit", "Ports de charge", "Wi-Fi / Bluetooth", "Face ID / Touch ID", "Composants CMS / IC"] },
                { icon: "🛠️", title: "Diagnostic & Solutions", items: ["Contrôle technique approfondi", "Identification précise", "Solutions fiables", "Réparation rapide", "Garantie durable"] }
              ].map((service, idx) => (
                <div key={idx} className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 hover:bg-gray-800/50 transition-all duration-300 border border-gray-700 hover:border-orange-500/50 group">
                  <div className="w-20 h-20 bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center text-4xl mb-6 mx-auto shadow-lg group-hover:scale-110 transition duration-300">{service.icon}</div>
                  ...
                  <ul className="space-y-2 text-gray-300 text-sm">{service.items.map((item, i) => (<li key={i} className="flex items-center gap-2">✓ {item}</li>))}</ul>
                </div>
              ))}
            </div>
            <div id="formation" className="bg-gradient-to-r from-orange-500 via-orange-600 to-orange-700 rounded-2xl p-12 text-center shadow-2xl border border-orange-400/50">
              ...
              <div className="grid md:grid-cols-3 gap-4 max-w-3xl mx-auto mb-8">
                {["Diagnostic de panne", "Réparation toutes marques", "Changement de composants", "Lecture de schémas", "Réparation carte mère", "Microsoudure pro"].map((item, i) => (<div key={i} className="flex items-center gap-2 bg-white/10 rounded-lg px-4 py-2.5 backdrop-blur-sm text-white">✔ {item}</div>))}
              </div>
              <a href="https://mobilax-academy.fr/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white text-orange-600 px-10 py-4 rounded-xl font-bold hover:bg-gray-100 hover:scale-105 transition-all duration-200 shadow-lg text-lg group">🎓 Demander une formation <span className="text-orange-400 group-hover:translate-x-1 transition-transform duration-200">→</span></a>
            </div>
          </div>
        </section>
        ...
        <section id="reparations" className="py-28 bg-black">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[{ icon: "📱", title: "Smartphones", desc: "iPhone, Samsung, Xiaomi, Pixel" }, { icon: "💻", title: "Ordinateurs", desc: "MacBook, PC portable, iMac" }, { icon: "📟", title: "Tablettes", desc: "iPad, Samsung Tab, Fire" }, { icon: "⌚", title: "Montres", desc: "Apple Watch, Galaxy Watch" }].map((item, idx) => (
                <div key={idx} className="text-center p-8 rounded-2xl hover:shadow-2xl transition-all duration-300 border border-gray-800 bg-gray-900/50 hover:border-orange-500/50 group">
                  <div className="w-24 h-24 bg-gradient-to-br from-orange-500/20 to-orange-600/20 rounded-2xl flex items-center justify-center text-4xl mx-auto mb-5 group-hover:scale-110 transition duration-300">{item.icon}</div>
        ...
        <section id="envoi" className="py-28 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <div className="inline-flex items-center gap-2 bg-orange-500/20 rounded-full px-5 py-2.5 mb-6 border border-orange-500/30"><span className="text-2xl">📦</span><span className="text-orange-400 font-semibold">Service clé en main</span></div>
                <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">Faites réparer vos appareils où que vous soyez</h2>
                <p className="text-gray-300 text-lg mb-8 leading-relaxed">Où que vous soyez en Europe, confiez-nous la réparation de votre appareil. Emballage sécurisé, garantie incluse.</p>
                <div className="space-y-5 mb-10">
                  {["France et Europe – Belgique, Suisse, Allemagne, Italie, Espagne", "Emballage sécurisé – Protection renforcée", "Garantie sur toutes nos réparations"].map((item, idx) => (
                    <div key={idx} className="flex items-start gap-3"><div className="w-7 h-7 bg-green-500 rounded-full flex items-center justify-center text-white text-sm mt-0.5 shadow-md">✓</div><p className="text-gray-300 font-medium">{item}</p></div>
                  ))}
                </div>
              </div>
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1580679568899-1b1b5e446ae3?w=600&h=500&fit=crop" alt="Colis réparation" className="rounded-2xl shadow-2xl w-full object-cover border border-gray-700" />
                <div className="absolute -top-6 -left-6 bg-gradient-to-r from-orange-500 to-orange-600 rounded-xl p-4 shadow-xl"><div className="flex items-center gap-3"><span className="text-3xl">🚚</span><div><p className="font-bold text-white">Livraison offerte</p><p className="text-xs text-orange-200">avec votre commande</p></div></div></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="commande" className="py-28 bg-black">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-16">
              <div className="inline-flex items-center gap-2 bg-orange-500/20 rounded-full px-5 py-2.5 mb-4 border border-orange-500/30"><span className="text-2xl">🛒</span><span className="text-orange-400 font-semibold">Boutique partenaire</span></div>
              <h2 className="text-4xl lg:text-5xl font-bold text-white mb-4">Commandez sur <a href="https://www.mobilax.fr" target="_blank" className="text-orange-500 hover:underline">mobilax.fr</a></h2>
              <p className="text-gray-400 text-lg max-w-2xl mx-auto">Pièces détachées, coques, chargeurs, écrans, batteries... Livraison gratuite avec votre réparation</p>
            </div>
            <div className="grid md:grid-cols-2 gap-8 mb-16 max-w-4xl mx-auto">
              <div className="bg-gray-900/50 rounded-2xl p-8 text-center border border-gray-800 shadow-lg hover:shadow-2xl transition-all duration-300 group hover:border-orange-500/50">
                <div className="w-24 h-24 bg-gradient-to-br from-orange-500/20 to-orange-600/20 rounded-2xl flex items-center justify-center text-4xl mx-auto mb-5 group-hover:scale-110 transition">📱</div>
            ...
            <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl p-10 text-white text-center shadow-2xl">
              <div className="grid md:grid-cols-3 gap-8"><div><div className="text-4xl mb-3">💰</div><p className="font-bold text-xl">Économies</p><p className="text-orange-100">Pas de frais de port</p></div><div><div className="text-4xl mb-3">📦</div><p className="font-bold text-xl">Colis unique</p><p className="text-orange-100">Appareil + commande</p></div><div><div className="text-4xl mb-3">⚡</div><p className="font-bold text-xl">Rapide</p><p className="text-orange-100">Traitement prioritaire</p></div></div>
            </div>
          </div>
        </section>
        ...
        <section id="contact" className="py-28 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16">
              <div>
                <div className="inline-flex items-center gap-2 bg-orange-500/20 rounded-full px-5 py-2.5 mb-6 border border-orange-500/30"><span className="text-xl">📍</span><span className="text-orange-400 font-semibold">Notre atelier</span></div>
          ...
          <div className="fixed inset-0 bg-black/95 z-50 flex items-center justify-center p-4" onClick={() => setShowVideo(false)}>
            <div className="relative max-w-5xl w-full" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="aspect-video bg-black rounded-2xl overflow-hidden shadow-2xl border border-orange-500/30">
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/_Ly_VG0SHP4" title="Vidéo MBX" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="fixed inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-4" onClick={() => setShowTrackingModal(false)}>
            <div className="relative max-w-md w-full bg-gradient-to-br from-gray-900 to-black rounded-2xl shadow-2xl p-8 border border-orange-500/30" onClick={(e) => e.stopPropagation()}>
              ...
              <form onSubmit={handleTrackSubmit}>
                <input type="text" value={trackingCode} onChange={(e) => setTrackingCode(e.target.value.toUpperCase())} placeholder="📱 Code client (ex: DOM923167)" className="w-full px-5 py-3 rounded-xl bg-gray-800/50 border border-gray-700 text-white placeholder-gray-500 mb-4 focus:outline-none focus:ring-2 focus:ring-orange-500 font-mono" required />
                {error && <p className="text-red-500 text-sm text-center mb-4">{error}</p>}
                <button type="submit" className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white py-3 rounded-xl font-semibold hover:from-orange-600 hover:to-orange-700 transition shadow-md">Suivre mon appareil</button>
              </form>
              <p className="text-center text-gray-500 text-xs mt-4">Nouveau client ? <a href="/client/soumettre-appareil" className="text-orange-500 hover:underline">Déclarez votre appareil</a></p>
            </div>
          </div>
        )}
      </div>
