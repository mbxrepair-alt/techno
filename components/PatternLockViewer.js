// components/PatternLockViewer.js
"use client";

export default function PatternLockViewer({ pattern }) {
        ...
        return (
          <div
            ...
            className={`absolute w-7 h-7 -ml-3.5 -mt-3.5 rounded-full flex items-center justify-center text-[10px] font-bold
              ${isSelected 
                ? isStartPoint 
                  ? 'bg-green-500 shadow-md ring-2 ring-green-300 text-white' 
                  : 'bg-orange-500 shadow-md ring-2 ring-orange-300 text-white'
